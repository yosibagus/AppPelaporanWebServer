...
if (isset($_GET['ktp_lap'])) {
	...
	$sql = "SELECT * FROM tb_laporan inner join tb_kategori on tb_kategori.kd_kat = tb_laporan.kd_kat inner join tb_user on tb_user.ktp_lap = tb_laporan.ktp_lap where tb_laporan.ktp_lap = '$ktp_lap' order by tb_laporan.kd_lap desc";
